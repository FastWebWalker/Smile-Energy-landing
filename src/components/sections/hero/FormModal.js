...
//         transition={{ duration: 0.3, ease: "easeInOut" }}>
//         <ContentContainer>
//           <div className="custom-scrollbar bg-white max-h-[80vh] overflow-x-hidden overflow-y-auto px-[3.05%] xl:py-[2.29%] py-[25px] rounded-md relative flex lg:flex-row flex-col justify-between xl:gap-[87px] gap-[20px]">
//             <style jsx global>{`
//               .custom-scrollbar {
//                 scrollbar-width: thin;
//                 scrollbar-color: #a40004 #f0f0f0;
//               }
